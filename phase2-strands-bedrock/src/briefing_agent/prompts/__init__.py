...
Phase 1 used the same pattern. Phase 2 keeps the convention because
prompt-as-file remains the right shape — markdown editor support,
diffable history, no source-file pollution.
